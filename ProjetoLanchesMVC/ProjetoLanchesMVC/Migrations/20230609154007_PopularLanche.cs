...
namespace ProjetoLanchesMVC.Migrations
{
    public partial class PopularLanche : Migration
    {
        ...
        {
            migrationBuilder.Sql("INSERT INTO Lanche(CategoriaId,DescricaoCurta,DescricaoDetalhada,EmEstoque,ImagemThumbnailUrl,ImagemUrl,IsLanchePreferido,Nome,Preco) " +
